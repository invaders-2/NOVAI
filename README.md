...
1. 启动服务后，浏览器打开 `http://127.0.0.1:3000`
2. 进入 **API 设置** 页面，配置你的 API 密钥
   - 支持 OpenAI、Gemini、火山引擎、ComfyUI 等多种服务
   - 推荐使用：https://apib.ai/register?aff=1uyAbb （包含所有生图/视频/LLM模型）

### 主要功能

| 功能 | 说明 |
|------|------|
| **无限画布** | 自由布局的创作空间，支持多图拼接与图层编辑 |
| **在线生图** | AI 驱动的图像生成引擎，支持文生图、图生图等 |
| **GPT 对话** | 智能 AI 助手，辅助创意构思与提示词优化 |
| **素材库** | 集中管理生成作品与上传素材，快速检索与复用 |
| **智能画布** | 增强版画布，支持更复杂的创作流程 |
...
#### Clone with HTTP
```bash
 git clone https://www.modelscope.cn/studios/bllack/NOVAI-Canvas.git
```
>>>>>>> modelscope/master
